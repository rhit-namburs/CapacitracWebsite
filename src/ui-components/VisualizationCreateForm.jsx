...
export default function VisualizationCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setInches(initialValues.inches);
    setAmps(initialValues.amps);
    setAmpsum(initialValues.ampsum);
    setErrors({});
  };
  const validations = {
    timeStamp: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Visualization(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "VisualizationCreateForm")}
      {...rest}
    >
      <TextField
        label="Time stamp"
